...
h2:nth-child(3){
	text-align:right;
	background:url(images/shadow_zasto.png) no-repeat 580px 20px;
	margin-top:55px;
}
h3{
	color:#636363;
...
<div class="holder">
    ...
    <div id="page1" class="page">
        <h2>O nama</h2>
        <p>
            Nudimo kompletnu uslugu knjigovodstva i računovodstva za poduzeća, obrte (standardne obrtnike i umjetnike) i udruge.
            Redovitim praćenjem zakonskih i poreznih propisa te hrvatskih i međunarodnih računovodstvenih standarda u 
            mogućnosti smo pružiti stručan i profesionalan pristup.
        </p>
        <h2>Zašto odabrati nas</h2>
        <p>
            Dvadeset godina iskustva te mnoštvo zadovoljnih klijenata naša su glavna referenca.
            Cilj nam je pružiti klijentima kvalitetnu, brzu i efikasnu uslugu koja će dodati stvarnu vrijednost vašem poslovanju.
        </p>
    </div>
    ...
    <div id="page4" class="page">
    	<h2>Kontakt</h2>
        <div>
        	<p><span>tel:</span>+385 52 2389395 </p>
        	<p><span>mob:</span>+385 98 334466</p>
        	<p><span>email:</span>icapara@gmail.com</p>
        	<p><span>oib:</span>02410562314</p>
        	<p><span>mb:</span>01026054 </p>
            <p><span>adresa:</span> Posavski Ljudevita 2, Pula</p>
            <p>Bajta d.o.o.</p>
            <div class="logo"></div>
        </div>
        <div>
